...
export function LiveResumeCounter() {
    ...
    return (
        ...
        >
            <div className="glass rounded-full border border-white/10 px-4 py-2 backdrop-blur-xl shadow-lg flex items-center gap-3">
                {/* Icon */}
                <div className="p-1.5 rounded-full bg-gradient-to-br from-neon-cyan/20 to-neon-purple/20">
