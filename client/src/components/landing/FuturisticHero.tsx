        ...
        <section ref={containerRef} className="relative min-h-screen flex items-center justify-center pt-32 pb-20 overflow-hidden bg-slate-950">
            ...
            >
                ...
                <motion.h1
                    ...
                    className="text-5xl sm:text-7xl lg:text-9xl font-black text-white leading-[0.9] sm:leading-[0.85] mb-6 sm:mb-10 tracking-tighter uppercase"
                >
                    ...
                    <span className="relative">
                        ...
                        <motion.span
                            ...
                            className="absolute -bottom-2 sm:-bottom-4 left-0 h-1 sm:h-2 bg-gradient-to-r from-neon-cyan via-neon-purple to-transparent rounded-full shadow-[0_0_20px_rgba(0,242,255,0.5)]"
                        />
                    </span>
                </motion.h1>
                ...
                <motion.p
                    ...
                    className="text-lg lg:text-2xl text-slate-400 max-w-3xl mx-auto mb-10 sm:mb-16 font-light leading-relaxed tracking-wide px-4 sm:px-0"
                >
                ...
                <motion.div
                    ...
                    className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8 mb-16 sm:mb-24 w-full sm:w-auto px-4"
                >
                    <Link href="/builder/new" className="w-full sm:w-auto">
                        <Button size="lg" className="relative w-full sm:w-auto h-16 sm:h-20 px-8 sm:px-16 rounded-full bg-white text-slate-950 text-xl sm:text-2xl font-black overflow-hidden group transition-all hover:scale-105 active:scale-95 shadow-[0_0_50px_rgba(255,255,255,0.2)]">
                            <span className="relative z-10 transition-colors group-hover:text-white">INITIALIZE BUILD</span>
                            ...
                            <ArrowRight className="relative z-10 w-5 h-5 sm:w-6 sm:h-6 ml-2 group-hover:translate-x-2 transition-transform group-hover:text-white" />
                        </Button>
                    </Link>

                    <button className="flex items-center gap-4 group">
                        <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full glass border-white/20 flex items-center justify-center group-hover:border-neon-cyan/50 transition-colors">
                            <Zap className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:text-neon-cyan transition-colors" />
                        </div>
                        <span className="font-black text-[10px] sm:text-sm uppercase tracking-widest text-slate-400 group-hover:text-white transition-colors">Watch Intelligence Probe</span>
                    </button>
                </motion.div>
