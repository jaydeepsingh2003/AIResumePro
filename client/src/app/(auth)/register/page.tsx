...
export default function RegisterPage() {
    ...
    return (
        <div className="flex min-h-screen bg-titanium-black overflow-hidden relative">
            ...
            {/* Right side: Form */}
            <div className="w-full lg:w-[650px] flex flex-col items-center justify-center p-4 sm:p-8 relative z-20 order-1">
                <motion.div
                ...
                >
                    ...
                    <div className="mb-10 sm:mb-14">
                        <h2 className="text-3xl sm:text-4xl font-black text-white tracking-tighter uppercase italic">Register.</h2>
                        <p className="text-slate-500 mt-2 sm:mt-3 text-[10px] sm:text-xs font-black uppercase tracking-widest">Construct your professional profile.</p>
                    </div>

                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 sm:space-y-6">
                        <div className="space-y-2 sm:space-y-3">
                            <label className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 ml-1">Universal Designation</label>
                            <Input
                        ...
                        <div className="space-y-2 sm:space-y-3">
                            <label className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.4em] text-slate-500 ml-1">Digital Identifier</label>
                            <Input
                        ...
                        <div className="space-y-2 sm:space-y-3">
                            <label className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 ml-1">Access Key</label>
                            <Input
                    ...
                    <p className="mt-10 sm:mt-12 text-center text-[8px] font-black uppercase tracking-[0.3em] text-slate-700 leading-relaxed">
