...
export default function LoginPage() {
    ...
    return (
        <div className="flex min-h-screen bg-titanium-black overflow-hidden relative">
            ...
            {/* Right side: Form */}
            <div className="w-full lg:w-[650px] flex flex-col items-center justify-center p-8 relative z-20">
                <motion.div
                ...
                >
                    ...
                    <div className="mb-14">
                        <h2 className="text-4xl font-black text-white tracking-tighter uppercase italic">Access.</h2>
                        <p className="text-slate-500 mt-3 text-xs font-black uppercase tracking-widest">Identify your digital footprint.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between items-center ml-1">
                                ...
                                <Link href="#" className="text-[10px] text-neon-purple font-black hover:underline uppercase tracking-widest">Lost Key?</Link>
                            </div>
                            <Input
                                placeholder="••••••••"
                        ...
                        <Button type="submit" className="w-full h-16 bg-white text-black hover:bg-neon-cyan rounded-2xl font-black uppercase tracking-[0.2em] text-xs transition-all hover:scale-[1.02] shadow-[0_0_30px_rgba(255,255,255,0.15)] mt-4 disabled:bg-slate-800 disabled:text-slate-500" disabled={loginMutation.isPending}>
